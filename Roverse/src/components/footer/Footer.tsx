    ...
    return (
        <>
            ...
            <div className="container-fluid bg-dark text-secondary mt-5 pt-5">
                ...
                <div className="row border-top mx-xl-5 py-4 footer-border-color" >
            ...
            {/* <!-- Back to Top --> */}
            <a onClick={() => gotoTop()} className="btn btn-primary back-to-top"><i className="fa fa-angle-double-up"></i></a>
