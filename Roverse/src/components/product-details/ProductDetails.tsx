...
export const ProductDetails = () => {
    ...
    let product = {
        title: 'Product Name Goes Here',
        Description: '',
        image1: '../../assets/img/product-' + (1) + '.jpg',
        image2: '../../assets/img/product-' + (2) + '.jpg',
        image3: '../../assets/img/product-' + (3) + '.jpg',
        image4: '../../assets/img/product-' + (4) + '.jpg',
        price: '$123',
        previousPrice: '$123'
    };
                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src={product.image1} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src={product.image2} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src={product.image3} alt="Image" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src={product.image4} alt="Image" />
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="media mb-4">
                                                <img src="img/user.jpg" alt="Image" className="img-fluid mr-3 mt-1" style={{
                                                    width: "45"
                                                }} />
